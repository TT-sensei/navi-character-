...
学習シーン素材は、国語・算数・理科・社会の教科別学習8種と、教科を限定しない二人組の相談・交流2種です。実際に読む・考える・測る・観察する・実験する・資料を関連付ける活動が伝わるよう、ポーズ・視線・手の動きを変えています。

- `assets/groups/learning/`：学習シーン原本PNG 10種
- `assets/web/groups/learning/`：Web用WebP 10種
